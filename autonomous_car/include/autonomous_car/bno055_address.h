#ifndef BNO055_ADDRESS_H
#define BNO055_ADDRESS_H
...
enum class Ascale : uint8_t {  // ACC Full Scale
  AFS_2G = 0,
  AFS_4G,
  AFS_8G,
  AFS_16G
...
enum class Abw : uint8_t { // ACC Bandwidth
  ABW_7_81Hz = 0,
  ABW_15_63Hz,
  ABW_31_25Hz,
  ABW_62_5Hz,
...
enum class APwrMode : uint8_t { // ACC Pwr Mode
  NormalA = 0,
  SuspendA,
  LowPower1A,
  StandbyA,
...
enum class Gscale : uint8_t{  // gyro full scale
  GFS_2000DPS = 0,
  GFS_1000DPS,
  GFS_500DPS,
  GFS_250DPS,
...
enum class GPwrMode : uint8_t{ // GYR Pwr Mode
  NormalG = 0,
  FastPowerUpG,
  DeepSuspendedG,
  SuspendG,
...
enum class Gbw : uint8_t{ // gyro bandwidth
  GBW_523Hz = 0,
  GBW_230Hz,
  GBW_116Hz,
  GBW_47Hz,
...
enum class OPRMode : uint8_t{  // BNO-55 operation modes
  CONFIGMODE = 0x00,
// Sensor Mode
  ACCONLY,
  MAGONLY,
...
enum class Modr : uint8_t{         // magnetometer output data rate
  MODR_2Hz = 0,
  MODR_6Hz,
  MODR_8Hz,
  MODR_10Hz,
...
enum class MOpMode : uint8_t{ // MAG Op Mode
  LowPower = 0,
  Regular,
  EnhancedRegular,
  HighAccuracy
...
enum class MPwrMode : uint8_t{ // MAG power mode
  Normal = 0,
  Sleep,
  Suspend,
  ForceMode
